...
function renderIdeas(d) {
  ...
  if (intro) intro.textContent = d.source === "ai"
    ? "Generated by FAAM AI from your watchlist — long, short, pairs and hedge plays."
...
/* ---------- Custom dashboard layout (Default · Build your own · AI) ----------
   ...
   panels), or ask FAAM AI to design one. Stored in localStorage and
...
async function aiDesignLayout() {
  ...
  try {
    ...
    note.textContent = d.source === "ai"
      ? "Designed by FAAM AI ✓ — fine-tune it under “Build your own.”"
...
function renderProUI() {
  ...
  lockBtn("#recapBtn", "recap");   // FAAM Learn is open to everyone while it's in development
